...
def cuda_archs() -> str:
    return os.getenv("FLASH_ATTN_CUDA_ARCHS", "80;87;90;100;120").split(";")
...
if not SKIP_CUDA_BUILD and not IS_ROCM:
    ...
    # Orin (Jetson AGX Orin) uses SM 8.7 — needs explicit gencode since v2.8.3
    # does NOT generate PTX forward-compat (only SASS).
    if "87" in cuda_archs():
        cc_flag.append("-gencode")
