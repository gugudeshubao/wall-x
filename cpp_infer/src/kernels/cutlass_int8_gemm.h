...
///
/// Computes:
///   output[M,N] = (act_int8[M,K] @ weight_int8^T[K,N]) * act_scale[M] * weight_scale[N] + bias[N]
/// All scale multiplications (and optional bias add) happen in the GEMM epilogue —
/// no INT32 writeback to GMEM. Output is BF16 directly.
///
